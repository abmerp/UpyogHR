package org.egov.land.abm.report;
...
//				smallBold));
	...
	private void addContent(Document document) throws DocumentException, JsonProcessingException {
		...
		if(newServiceInfo!=null) {
			JSONObject jsonObject = new JSONObject(newServiceInfo);
			System.out.println("json object : " + jsonObject);
			ObjectMapper Obj = new ObjectMapper();
			
			System.out.println("json object : ===========>" +jsonObject.getJSONArray("newServiceInfoData").getJSONObject(0).getJSONObject("feesAndCharges").getString("scrutinyFee"));
			...
			Integer totalFee = 0;
			 ...
			 String scrutinyFee = jsonObject.getJSONArray("newServiceInfoData").getJSONObject(0).getJSONObject("feesAndCharges").getString("scrutinyFee");
			 String licenseFee =jsonObject.getJSONArray("newServiceInfoData").getJSONObject(0).getJSONObject("feesAndCharges").getString("licenseFee");
			 String adjustFee =jsonObject.getJSONArray("newServiceInfoData").getJSONObject(0).getJSONObject("feesAndCharges").getString("adjustFee");
