...
@AllArgsConstructor
@Builder
public class BPARequestDao {
	@JsonProperty("RequestInfo")
	private RequestInfo requestInfo = null;

	@JsonProperty("BPA")
	private BPADao BPA = null;

	public BPARequestDao requestInfo(RequestInfo requestInfo) {
	...
	public BPARequestDao BPA(BPADao BPA) {
		this.BPA = BPA;
		return this;
	}
	...
	@Valid
	public BPADao getBPA() {
		return BPA;
	}

	public void setBPA(BPADao BPA) {
		this.BPA = BPA;
	}
	...
	public boolean equals(java.lang.Object o) {
		...
		BPARequestDao bpARequest = (BPARequestDao) o;
		return Objects.equals(this.requestInfo, bpARequest.requestInfo) && Objects.equals(this.BPA, bpARequest.BPA);
	}
